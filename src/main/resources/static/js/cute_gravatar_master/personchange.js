...
// 目的：记录选中的人物状态
// 小Tag：
// 1、动态改变发色、肤色时。对应color会改变
// 2、动态改变发型、脸型……时对应id会改变
...
function personInitA() {
	console.log("进入人物初始化：personInitA()");
	bodyChange(1);
...
function personInitB() {
	console.log("进入人物初始化：personInitB()");
	bodyChangeB(1);
